              ...
              <div className="bg-gradient-to-br from-sky-50 to-indigo-50 rounded-2xl p-6 border border-sky-200">
                ...
                <div className="flex items-baseline gap-2 mb-4">
                  <span className="text-4xl font-extrabold text-slate-900">
                    â‚¹{product.finalTotal?.toLocaleString('en-IN') || product.price?.toLocaleString('en-IN')}
                  </span>
                ...
                {product.discount && (
                  <p className="text-sm font-bold text-emerald-700">ðŸ’š Save â‚¹{product.discount.toLocaleString('en-IN')}</p>
                )}
              </div>
            ...
            <div className="bg-gradient-to-r from-indigo-50 to-purple-50 rounded-2xl p-6 border border-indigo-200">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-600">Rating: â­ {product.merchantRating || 4.8}/5.0</p>
                </div>
              </div>
            </div>
          </div>
